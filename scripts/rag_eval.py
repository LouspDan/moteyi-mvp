...
def retrieve_ids(query: str, k: int, cfg: Dict) -> List[str]:
    ...
    if mode == "oracle":
        # En mode oracle, l'évaluateur lui-même ne connaît pas la "bonne réponse".
        # On renverra une liste vide => coverage/hit reflètent le retriever réel quand il sera branché.
        # Pour smoke test, on peut simuler un "pas trouvé" (liste vide).
        return []
